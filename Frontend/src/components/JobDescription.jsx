  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
      <div className='flex items-center justify-between'>
        ...
        <Button disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed ' : 'bg-[#7209b7] hover:bg-[#540887] cursor-pointer'}`}>{isApplied ? 'Already Applied' : 'Apply now'}</Button>
      </div>
      ...
      <div className='my-4'>
        ...
        <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, quidem?</span></h1>
        ...
        <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>09-09-2025</span></h1>
      </div>
    </div>
  )
}
